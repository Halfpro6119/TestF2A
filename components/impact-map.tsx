...
export function ImpactMap({ className = "" }: ImpactMapProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {tooltipContent && (
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-brand-navy text-white text-xs sm:text-sm font-medium px-3 sm:px-4 py-2 rounded-lg shadow-lg pointer-events-none z-10 max-w-[calc(100vw-2rem)] sm:max-w-none sm:whitespace-nowrap text-center"
          role="tooltip"
        >
          {tooltipContent}
        </div>
